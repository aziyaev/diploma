...
\begin{abstract}
This paper describes the results achieved in the course of expanding the functionality of the distance learning system "Moscow State University Contest", improving the process of checking students' work and ensuring safety when compiling and running user programs in the system.

Implemented a custom text editing solution. The existing software structure of the system was redesigned for the implementation in the system of new types of tasks issued for solving by students. Structural solutions are introduced and a user interface is described that implements new types of issued tasks and how users interact with them. A tool has been used to isolate the compilation process and launch of user programs in the system in order to ensure security on the server.
\end{abstract}
...
Форма редактирования пользовательского текста предоставляет обширную функциональность для редактирования и форматирования текста в поле для ввода на веб-странице, копирование из Microsoft Word с сохранением исходного форматирования.
...
Для использования указывается необходимая конфигурация в глобальных настройках проекта. Конифигурация позволяет выбрать кнопки, доступные опции и визуальные элементы для редактора, внешний вид, некоторые подробности встраивания в окружающую разметку.
